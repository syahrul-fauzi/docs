...
status: active
scope: global
tags: [agent, ai, reasoning, behavior, learning]
---

# 🤖 03 - Agentic Core

Folder ini berisi dokumentasi inti mengenai desain AI Agent, pola penalaran (reasoning), perilaku otonom, dan mekanisme pembelajaran berkelanjutan.
...
- **[Agent Capability Registry Spec](../Strategy%20&%20Capability%20Framework/Agent%20Capability%20Registry%20Spec.md)**: Spesifikasi penemuan kemampuan dan routing agen.
...
- AI Agent Architects
- AI Developers
- AI Agents (untuk memahami jati diri dan aturan main mereka)
