...
## 🖥️ Unified Desktop Control Plane (Internal Console)

**Internal Console** (`apps/internal-console`) adalah pusat saraf operasional untuk SBA-Agentic. Ini adalah aplikasi desktop (direncanakan berbasis Tauri) yang memberikan kontrol penuh, visibilitas, dan kemampuan orkestrasi kepada operator manusia.

### Pilar Utama Internal Console

1. **Control Center**: Mengelola siklus hidup agen, workflow, dan konfigurasi tenant secara terpusat.
2. **Intelligence Surface**: Visualisasi penalaran agen (Reasoning Trace) dan umpan balik real-time dari AI.
3. **Governance & Policy**: Editor visual untuk aturan Rube (YAML) dengan validasi keamanan otomatis.
4. **Observability Hub**: Monitoring telemetri agen, audit log immutable, dan deteksi anomali operasional.

### Dokumentasi Terkait

- **[Landing Page & Kontrak Teknis](./00-index/Control%20%26%20Intelligence%20Console%20%E2%80%94%20Sba-agentic.md)**
- **[Spesifikasi Use Case (UC-01 - UC-04)](./01-product/Use%20Case%20Specifications%20%E2%80%94%20Internal%20Console%20(sba-agentic).md)**
- **[Arsitektur Detail](./02-architecture/Arsitektur%20internal-console.md)**

---

## 🚀 Status Kesiapan & Go-Live

Saat ini kami sedang dalam fase **Full Go-Live Simulation (v1.2.0)**. Seluruh komponen inti telah divalidasi dan siap untuk peluncuran produksi.

- **Checklist Kesiapan**: [PRODUCTION_READINESS_CHECKLIST.md](./10-release-go-live/PRODUCTION_READINESS_CHECKLIST.md)
- **Rencana Simulasi**: [Simulasi Full Go-Live End-to-End.md](./.trae/simulasi%20full%20go-live%20end-to-end.md)
- **Laporan Progres**: [PROGRESS.md](./PROGRESS.md)
...
Mulai dari entry point yang paling terstruktur:

- **[Master Index (00-index)](./00-index/README.md)**
- **[Documentation Index (ringkas)](./INDEX.md)**

### 🧭 Navigasi Cepat berdasarkan Peran

| Peran | Titik awal rekomendasi |
| :--- | :--- |
| **Developer** | [🏗️ Arsitektur](./02-architecture/COMPREHENSIVE_ARCHITECTURE.md) & [🛠️ SBA Implementation Guide](./Strategy%20%26%20Capability%20Framework/guides/SBA_Implementation_Guide.md) |
| **Product Manager** | [🚀 Product & Business](./01-product/README.md) & [📜 Strategy & Capability](./Strategy%20%26%20Capability%20Framework/registry/README.md) |
...
- **[`Strategy & Capability Framework/`](./Strategy%20%26%20Capability%20Framework/)**:
  - **[`registry/`](./Strategy%20%26%20Capability%20Framework/registry/)**: Sumber kebenaran semantik (Intent & Capability Registry).
  - **[`concepts/`](./Strategy%20%26%20Capability%20Framework/concepts/)**: Filosofi desain dan desain fitur dasar.
  - **[`specs/`](./Strategy%20%26%20Capability%20Framework/specs/)**: Spesifikasi teknis formal untuk integrasi mesh.
  - **[`guides/`](./Strategy%20%26%20Capability%20Framework/guides/)**: Panduan implementasi bagi developer.

## 📦 Core Packages (Internal Library)

SBA-Agentic menggunakan arsitektur monorepo dengan paket-paket inti berikut:

- **[`@sba/agentic-reasoning`](../packages/agentic-reasoning/)**: Mesin penalaran (Analysis, Planning, Reflection).
- **[`@sba/rube`](../packages/rube/)**: Engine penegakan aturan bisnis, policy, dan guards.
- **[`@sba/sdk`](../packages/sdk/)**: SDK untuk membangun kapabilitas agen yang deterministik.
- **[`@sba/control-plane`](../packages/control-plane/)**: Kontrak dan library untuk control plane.
- **[`@sba/services`](../packages/services/)**: Service layer lintas domain (API/orchestrator).
- **[`@sba/entities`](../packages/entities/)**: Domain entities, DTO, schema, dan event standar.
- **[`@sba/integrations`](../packages/integrations/)**: Connector & adapter pihak ketiga (CRM/ERP/dll).
- **[`@sba/security`](../packages/security/)**: Protokol keamanan, PII masking, dan audit log.
- **[`@sba/observability`](../packages/observability/)**: Monitoring, tracing, dan metrik sistem.
- **[`@sba/auth`](../packages/auth/)**: Integrasi autentikasi Supabase & JWT.
- **[`@sba/ui`](../packages/ui/)**: Koleksi komponen UI desain sistem SBA.

Paket lain yang sering dipakai:

- **[`@sba/api-client`](../packages/api-client/)**, **[`@sba/api-types`](../packages/api-types/)**: Client dan tipe API lintas apps.
- **[`@sba/supabase`](../packages/supabase/)**: Wrapper Supabase dan helper auth/DB.
- **[`@sba/realtime`](../packages/realtime/)**: Realtime primitives dan subscription layer.
- **[`@sba/logger`](../packages/logger/)**, **[`@sba/telemetry`](../packages/telemetry/)**: Logging dan telemetry.
- **[`@sba/kv`](../packages/kv/)**: Abstraksi key-value storage.
- **[`@sba/analytics`](../packages/analytics/)**: Analytics client/server.
- **[`@sba/email`](../packages/email/)**: Notifikasi email dan provider.

Domain business packages (workspaces `packages/business/*`):

- **[`@sba/business-core`](../packages/business/business-core/)**, **[`@sba/business-analytics`](../packages/business/business-analytics/)**, **[`@sba/business-chat`](../packages/business/business-chat/)**, **[`@sba/business-knowledge`](../packages/business/business-knowledge/)**, **[`@sba/business-payment`](../packages/business/business-payment/)**.

---

## 📅 Strategi & Roadmap Operasional

Dokumen perencanaan strategis dan simulasi peluncuran:

- **[PRIORITY EXECUTION ROADMAP 30-60-90 Hari](./.trae/PRIORITY%20EXECUTION%20ROADMAP%2030-60-90%20Hari.md)** — Rencana eksekusi jangka menengah.
- **[Simulasi Full Go-Live End-to-End](./.trae/simulasi%20full%20go-live%20end-to-end.md)** — Panduan otoritatif simulasi produksi.
- **[Rencana Peningkatan Menyeluruh](./.trae/rencana%20peningkatan%20menyeluruh%20(agentic-driven,%20production-grade).md)** — Visi peningkatan sistem skala enterprise.
...
SBA-Agentic mengadopsi arsitektur **Agentic AI Mesh** yang didukung oleh pemisahan tegas antara **Control Plane** (Otak) dan **Agent Runtime** (Tangan).
Arsitektur ini dirancang untuk skalabilitas perusahaan dengan prinsip **Layered Decoupling** (Logic, Memory, Orchestration, Interface) dan **Vendor Neutrality** melalui standar terbuka seperti **Model Context Protocol (MCP)** dan **Agent-to-Agent (A2A) Protocol**.
...
1. **[Intent Registry](./Strategy%20%26%20Capability%20Framework/registry/Intent%20Registry%20YAML%20(Global%20SBA).md)**: Mendefinisikan *apa* yang diinginkan pengguna. Menggunakan YAML production-grade untuk klasifikasi intent yang deterministik dan aman.
2. **[Capability Registry](./Strategy%20%26%20Capability%20Framework/registry/Capability%20Registry%20YAML%20(Control%20Plane%20Source%20of%20Truth).md)**: Mendefinisikan *bagaimana* sistem mengeksekusi keinginan tersebut melalui unit fungsional yang terukur.
...
- **[📜 Capability Coverage Map](./Strategy%20%26%20Capability%20Framework/registry/Capability%20Coverage%20Map.md)**: Peta jalan kapabilitas, kontrak intent, dan fondasi operasional (Policy, Pricing, Routing, Scale).
- **[📒 Agent Capability Registry](./Strategy%20%26%20Capability%20Framework/specs/Agent%20Capability%20Registry%20Spec.md)**: Spesifikasi teknis mendalam, interop standar (A2A/ANS), dan skema validasi.
- **[🛡️ Policy Enforcement Spec](./Strategy%20%26%20Capability%20Framework/specs/Policy%20Enforcement%20Spec%20%E2%80%94%20Capability%20%C3%97%20Tenant%20%C3%97%20Risk.md)**: Mekanisme keamanan dinamis (IBAC) dan tata kelola aksi agen.
- **[📦 Agent Runtime SDK](./Strategy%20%26%20Capability%20Framework/guides/Agent%20Runtime%20SDK%20(TypeScript).md)**: Panduan bagi developer untuk membangun kapabilitas baru yang mematuhi standar mesh.
